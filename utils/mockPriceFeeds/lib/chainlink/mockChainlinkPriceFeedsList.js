...
const feeds = [
    { name: "r:plnEth",  network: "ropsten", address: "0x382975824786BF53e5Ad4726b51F89959218d0Ec", source: getSrc("plnEth",  "ropsten")[0] },
    { name: "r:ethUsd",  network: "ropsten", address: "0x71271d853A665758b8E81bE8cd54B9a54877321e", source: getSrc("ethUsd",  "ropsten")[0] },
    { name: "r:compUsd", network: "ropsten", address: "0xC9e417fbF07019b7cCDA6f83D0bc6073F5B4819E", source: getSrc("compUsd", "ropsten")[0] },
    { name: "r:batEth",  network: "ropsten", address: "0x06a3dD64A3dF8FF45a29cE17BAC8ddD5B74b834c", source: getSrc("batEth",  "ropsten")[0] },
    { name: "r:daiEth",  network: "ropsten", address: "0x6f4a9e4057A99De37537acC02968B2B2c8e575B4", source: getSrc("daiEth",  "ropsten")[0] },
    { name: "r:lendEth", network: "ropsten", address: "0xeE44558Ef55f4f7890ED66cd89d4367051e0cF9d", source: getSrc("lendEth", "ropsten")[0] },
    { name: "r:linkEth", network: "ropsten", address: "0xc78A1B93Fa50A58f89f2be2f2160FDA51a4141F4", source: getSrc("linkEth", "ropsten")[0] },
    { name: "r:mkrEth",  network: "ropsten", address: "0x75064F1347FB6196EF8f6B53120630281ba6cb35", source: getSrc("mkrEth",  "ropsten")[0] },
    { name: "r:snxEth",  network: "ropsten", address: "0x87199Ffc02BD459331E1422bbaC1A171262e5744", source: getSrc("snxEth",  "ropsten")[0] },
