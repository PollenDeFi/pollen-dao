...
contract PollenToken is ERC20, Ownable {
    ...
    /// @notice Sets the address of the PollenDAO,
    /// @dev can only be called from the owner which sets the dao address
    /// which has sole mint/burn privileges. Can only be set once
