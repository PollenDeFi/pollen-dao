...
const feeds = [
    ...
    { name: "r:batEth",  network: "ropsten", address: "", source: getSrc("batEth",  "mainnet")[0] },
    { name: "r:daiEth",  network: "ropsten", address: "", source: getSrc("daiEth",  "mainnet")[0] },
    { name: "r:lendEth", network: "ropsten", address: "", source: getSrc("lendEth", "mainnet")[0] },
    ...
    { name: "r:snxEth",  network: "ropsten", address: "", source: getSrc("snxEth",  "mainnet")[0] },
